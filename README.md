...
PHENOML_USERNAME=
PHENOML_PASSWORD=
PHENOML_BASE_URL=              # e.g., https://xprimarycare.app.pheno.ml
PHENOML_FHIR_PROVIDER_ID=     # From PhenoML dashboard

# FHIR Practitioner
NEXT_PUBLIC_FHIR_PRACTITIONER_ID=

# Chart Review API
CHART_REVIEW_API_URL=          # e.g., https://api.xprimarycare.com
CHART_REVIEW_API_SECRET=
NEXT_PUBLIC_PRACTITIONER_NAME= # e.g., "Jane Doe, MD"
