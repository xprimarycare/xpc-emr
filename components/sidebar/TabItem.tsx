      ...
      >
        ...
        {isEditing ? (
          ...
          <span
            ...
            style={isHovered && isOverflowing && nameRef.current ? {
              overflow: 'hidden',
            } : undefined}
          >
            {isHovered && isOverflowing && nameRef.current ? (
              <span
                className="inline-block whitespace-nowrap"
                style={{
                  '--scroll-distance': `${-(nameRef.current.scrollWidth - nameRef.current.clientWidth)}px`,
                  animation: `tabNameScroll ${Math.max(1, (nameRef.current.scrollWidth - nameRef.current.clientWidth) * 0.02)}s linear 0.3s forwards`,
        ...
        {!isEditing && (
          <button
            ...
            className={`p-0.5 hover:bg-gray-200 rounded ${
              isHovered || isActive || tab.starred ? 'opacity-100' : 'opacity-0 pointer-events-none'
            }`}
          >
            <Star
              size={14}
